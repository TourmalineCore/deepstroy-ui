...
function Ie(e2, t2, r2, n, o) {
  ...
  }), a) : (a = parse(e2, t2, new Date(), { locale: s }), n ? i = Oe(a) && e2 === Te(a, t2, r2) : Oe(a) || (t2 = t2.match(xe).map(function(e3) {
    var t3 = e3[0];
    return "p" === t3 || "P" === t3 ? s ? (0, Ne[t3])(e3, s.formatLong) : t3 : e3;
  }).join(""), e2.length > 0 && (a = parse(e2, t2.slice(0, e2.length), new Date())), Oe(a) || (a = new Date(e2))), Oe(a) && i ? a : null);
}
function Oe(e2, t2) {
...
function Yt(e2, t2) {
  for (var r2 = [], n = We(e2), o = We(t2); !isAfter(n, o); )
...
var Tt = function(t2) {
  ...
  function n() {
    ...
    for (var o = arguments.length, a = new Array(o), s = 0; s < o; s++)
      a[s] = arguments[s];
    return ve(ke(t3 = r2.call.apply(r2, [this].concat(a))), "state", { dropdownVisible: false }), ve(ke(t3), "renderSelectOptions", function() {
      for (var r3 = We(t3.props.minDate), n2 = We(t3.props.maxDate), o2 = []; !isAfter(r3, n2); ) {
        var a2 = getTime(r3);
      ...
      return import_react2.default.createElement("select", { value: getTime(We(t3.props.date)), className: "react-datepicker__month-year-select", onChange: t3.onSelectChange }, t3.renderSelectOptions());
    }), ve(ke(t3), "renderReadView", function(r3) {
...
var Rt = function(t2) {
  ...
  function o() {
    ...
    }), ve(ke(t3), "getHighLightedClass", function(e2) {
      var r2 = t3.props, n2 = r2.day, o2 = r2.highlightDates;
      if (!o2)
        return false;
      var a2 = Te(n2, "MM.dd.yyyy");
      return o2.get(a2);
...
var Qt = function(t2) {
  ...
  function o() {
    ...
    return ve(ke(t3 = n.call.apply(n, [this].concat(s))), "MONTH_REFS", Ce(Array(12)).map(function() {
      ...
      t3.handleDayClick(We(setMonth(t3.props.day, r2)), e2);
    }), ve(ke(t3), "onMonthMouseEnter", function(e2) {
      t3.handleDayMouseEnter(We(setMonth(t3.props.day, e2)));
      ...
      if ("Tab" !== d && e2.preventDefault(), !s2) {
        var u = Ht(p, i2), h = Wt[u].verticalNavigationOffset, m = Wt[u].grid;
        switch (d) {
          case "Enter":
      ...
      return Wt[Ht(a2, o2)].grid.map(function(r3, o3) {
        return import_react2.default.createElement("div", { className: "react-datepicker__month-wrapper", key: o3 }, r3.map(function(r4, o4) {
          ...
          }, tabIndex: t3.getTabIndex(r4), className: t3.getMonthClassNames(r4), role: "option", "aria-label": t3.getAriaLabel(r4), "aria-current": t3.isCurrentMonth(i2, r4) ? "date" : void 0, "aria-selected": t3.isSelectedMonth(i2, r4, p) }, n2 ? tt(r4, s2) : rt(r4, s2));
        }));
      });
      ...
      return import_react2.default.createElement("div", { className: "react-datepicker__quarter-wrapper" }, [1, 2, 3, 4].map(function(r3, a2) {
        ...
        }, className: t3.getQuarterClassNames(r3), "aria-selected": t3.isSelectedQuarter(n2, r3, o2), tabIndex: t3.getQuarterTabIndex(r3), "aria-current": t3.isCurrentQuarter(n2, r3) ? "date" : void 0 }, nt(r3, t3.props.locale));
      }));
...
ve(jt, "calcCenterPosition", function(e2, t2) {
...
var Vt = function(t2) {
  ...
  function o(t3) {
    ...
    return he(this, o), ve(ke(a = n.call(this, t3)), "YEAR_REFS", Ce(Array(a.props.yearItemNumber)).map(function() {
      ...
      var t4 = He(setYear(a.props.date, e2));
      return !a.props.disabledKeyboardNavigation && !a.props.inline && !ze(t4, He(a.props.selected)) && ze(t4, He(a.props.preSelection));
    }), ve(ke(a), "onYearClick", function(e2, t4) {
      var r2 = a.props.date;
      a.handleYearClick(He(setYear(r2, t4)), e2);
  ...
  return fe(o, [{ key: "render", value: function() {
    for (var t3 = this, r2 = [], n2 = this.props, o2 = n2.date, a = n2.yearItemNumber, s = n2.onYearMouseEnter, i = n2.onYearMouseLeave, p = _t(o2, a), c = p.startPeriod, l = p.endPeriod, d = function(n3) {
      r2.push(import_react2.default.createElement("div", { ref: t3.YEAR_REFS[n3 - c], onClick: function(e2) {
        ...
        return i(e2, n3);
      }, key: n3, "aria-current": t3.isCurrentYear(n3) ? "date" : void 0 }, n3));
    }, u = c; u <= l; u++)
      d(u);
...
var $t = function(t2) {
  ...
  function o(t3) {
    ...
    return he(this, o), ve(ke(a = n.call(this, t3)), "handleClickOutside", function(e2) {
      ...
      if (!a.props.renderCustomHeader) {
        ...
        switch (true) {
          ...
          case a.props.showYearPicker:
            t4 = function(e2) {
              var t5 = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, r3 = t5.minDate, n3 = t5.yearItemNumber, o3 = void 0 === n3 ? 12 : n3, a2 = _t(He(subYears(e2, o3)), o3).endPeriod, s2 = r3 && getYear(r3);
      ...
      a.props.onSelect(je(), e2), a.props.setPreSelection && a.props.setPreSelection(je());
...
var Xt = function(t2) {
  ...
  function n(t3) {
    ...
    }), ve(ke(o), "handleFocusStart", function(e2) {
      var t4 = o.getTabChildren();
      t4 && t4.length > 1 && t4[t4.length - 1].focus();
    }), ve(ke(o), "handleFocusEnd", function(e2) {
      var t4 = o.getTabChildren();
